...
"""Generate high-polish Rebble App Store assets including exact 200x228 Emery screenshots and banner."""
...
def generate_banner_720x320(official_logo_path: str) -> Image.Image:
    """Generate 720x320 banner with official Antigravity logo, Pebble mockup, and exact requested text."""
    w, h = 720, 320
    ...
    g1_draw.ellipse([20, 40, 280, 300], fill=(0, 240, 255, 40))
    g1_draw.ellipse([460, 40, 710, 300], fill=(0, 230, 118, 35))
    ...
    banner.paste(logo_resized, (42, 70), logo_resized)

    # Green Approve Badge overlaid on the Antigravity Logo
    badge = create_green_checkmark_badge(60)
    banner.paste(badge, (160, 185), badge)
    ...
    # Pebble Watch Screen inside Mockup
    header_h = 16
    ...
    # 3. Center Typography with exact requested message
    draw.text((245, 65), "AGENT APPROVALS", fill=(0, 240, 255, 255))
    draw.text((245, 92), "(ANTIGRAVITY)", fill=(255, 255, 255, 255))

    # Exact requested explanation text across structured lines
    text_lines = [
        "Approve your coding agent",
        "(like Antigravity) from your wrist,",
        "with the Pebble Time 2 app",
        "(and web extension)."
    ]
    txt_y = 135
    for line in text_lines:
        draw.text((245, txt_y), line, fill=(226, 232, 240, 255))
        txt_y += 22

    # Footer attribution
    draw.text((245, 245), "BY @SAVELEE • GITHUB.COM/SAVELEE", fill=(0, 230, 118, 255))
...
def main():
    ...
    if os.path.exists(official_logo_path):
        ...
        # 5. Redone Banner 720x320 with exact explanation text
    ...
    print("\n✨ Redone banner and all assets generated successfully!")
